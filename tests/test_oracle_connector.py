...
class TestOracleConnector:
    ...
    def test_execute_query_success(self):
        ...
        success, result = self.connector.execute_query("SELECT table_name FROM user_tables")
        
        assert success is True
        assert result == [("USERS",), ("ORDERS",)]
        mock_cursor.execute.assert_called_once_with("SELECT table_name FROM user_tables")
    ...
    def test_table_exists_true(self):
        ...
        expected_query = "SELECT COUNT(*) FROM user_tables WHERE table_name = UPPER('users')"
        mock_cursor.execute.assert_called_once_with(expected_query)
