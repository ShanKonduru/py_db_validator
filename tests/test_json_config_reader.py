...
class TestJsonConfigReader:
    ...
    def test_get_environments_invalid_structure(self):
        ...
        with pytest.raises(ValueError, match="Environments section must be a dictionary"):
    ...
    def test_get_applications_invalid_environment_data(self):
        ...
        with pytest.raises(ValueError, match="Environment 'DEV' data must be a dictionary"):
    ...
    def test_get_connection_config_invalid_app_config(self):
        ...
        with pytest.raises(ValueError, match="Application 'RED' configuration must be a dictionary"):
    ...
    def test_get_connection_config_missing_required_field(self):
        ...
        with pytest.raises(ValueError, match="Missing required field 'port' in DEV.RED configuration"):
            JsonConfigReader.get_connection_config(config, "DEV", "RED")
    ...
    def test_validate_config_structure_missing_required_fields(self):
        ...
        errors = JsonConfigReader.validate_config_structure(config)
        assert any("Missing required field 'host' in DEV.RED" in error for error in errors)
        assert any("Missing required field 'port' in DEV.RED" in error for error in errors)
        assert any("Missing required field 'database' in DEV.RED" in error for error in errors)
